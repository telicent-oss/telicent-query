...
window.APP_SWITCH_LIBRARY = [
  {
    ...
    iconDark: '/query/assets/icons/GraphDark.svg',
    iconLight: '/query/assets/icons/GraphLight.svg',
  },
  {
    id: 'telicent-user-portal',
    name: 'user portal',
    url: 'https://${APP_HOST_DOMAIN}/user-portal/',
    iconDark: '/query/assets/icons/UserPortalDark.svg',
    iconLight: '/query/assets/icons/UserPortalLight.svg',
  },
  {
    id: 'telicent-search',
    name: 'search',
    url: 'https://${APP_HOST_DOMAIN}/search/',
    iconDark: '/query/assets/icons/SearchDark.svg',
    iconLight: '/query/assets/icons/SearchLight.svg',
  },
  {
    id: 'telicent-catalog',
    name: 'catalog',
    url: 'https://${APP_HOST_DOMAIN}/data-catalog/',
    iconDark: '/query/assets/icons/CatalogDark.svg',
    iconLight: '/query/assets/icons/CatalogLight.svg',
  },
];
